...
echo "- [Prepare Super-Resolution Datasets](./1_super_resolution_datasets.md)" >> dataset_zoo/0_overview.md
...
echo "- [Prepare Inpainting Datasets](./2_inpainting_datasets.md)" >> dataset_zoo/0_overview.md
...
echo "- [Prepare Matting Datasets](./3_matting_datasets.md)" >> dataset_zoo/0_overview.md
cat dataset_zoo/3_matting_datasets.md | grep -oP '(- \[.*-dataset.*)' | sed 's/- \[/  - \[/g' | sed 's/(#/(.\/3_matting_datasets.md#/g' >> dataset_zoo/0_overview.md
echo "- [Prepare Video Frame Interpolation Datasets](./4_video_interpolation_datasets.md)" >> dataset_zoo/0_overview.md
...
echo "- [Prepare Unconditional GANs Datasets](./5_unconditional_gans_datasets.md)" >> dataset_zoo/0_overview.md
...
echo "- [Prepare Image Translation Datasets](./6_image_translation_datasets.md)" >> dataset_zoo/0_overview.md
