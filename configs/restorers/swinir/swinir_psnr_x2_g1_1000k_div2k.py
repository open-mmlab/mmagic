exp_name = 'swinir_psnr_x2_g1_1000k_div2k'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file='data/DIV2K/DIV2K_train_LR_bicubic_X2_sub.lmdb/meta_info.txt',
    ...
    val=dict(
        ...
        lq_folder='/nas/k8s/dev/mlops/dataset-artifacts/super_resolution/version_1/data/set5/bicLRx2',
    ...
    test=dict(
        ...
        lq_folder='/nas/k8s/dev/mlops/dataset-artifacts/super_resolution/version_1/data/set14/bicLRx2',
