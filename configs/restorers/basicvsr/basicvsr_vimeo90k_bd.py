...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='/mnt/lustre/share/kckchan/Datasets/vimeo90k/BDx4',
            gt_folder='/mnt/lustre/share/kckchan/Datasets/vimeo90k/GT',
    ...
    val=dict(
        ...
        lq_folder='/mnt/lustre/share/kckchan/Datasets/Vid4/BDx4',
        gt_folder='/mnt/lustre/share/kckchan/Datasets/Vid4/GT',
...
load_from = None
resume_from = './experiments/BasicVSR_Vimeo_BD_test/iter_5.pth'
workflow = [('train', 1)]
