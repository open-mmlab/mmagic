...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            gt_folder='dataset/DF2K_train_HR_sub',  # Your training data path
            pipeline=train_pipeline,
            scale=scale)),
    val=dict(
        type=val_dataset_type,
        lq_folder='dataset/DIV2KRK/lr_x4',  # Your validation data LR path
        gt_folder='dataset/DIV2KRK/gt',  # Your validation data HR path
...
load_from = 'mmediting/danx4_l1_256/iter_40000.pth'
resume_from = None
workflow = [('train', 1)]
