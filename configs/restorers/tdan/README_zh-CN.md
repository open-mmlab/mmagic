...
更多细节可以参考 [getting_started](/docs/getting_started.md#train-a-model) 中的 **Train a model** 部分。
</details>
...
更多细节可以参考 [getting_started](/docs/getting_started.md#inference-with-pretrained-models) 中的 **Inference with pretrained models** 部分。
</details>
