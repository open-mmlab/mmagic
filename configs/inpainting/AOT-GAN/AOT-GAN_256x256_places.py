...
train_pipeline = [
    ...
    dict(type='LoadMask',
        mask_mode='set',
        mask_config=dict(
            mask_list_file='/home/SENSETIME/lintsuihin/code/mmediting/data/places365_test_mask/mask_list.txt',
            prefix='/home/SENSETIME/lintsuihin/code/mmediting/data/places365_test_mask',
            io_backend='disk',
            flag='unchanged',
...
exp_name = 'AOT-GAN_256x256_places'
