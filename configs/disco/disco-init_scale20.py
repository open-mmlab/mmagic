...
pretrained_cfgs = dict(
    unet=dict(ckpt_path='https://download.openmmlab.com/mmediting/synthesizers/disco/adm-u_finetuned_imagenet-512x512-ab471d70.pth', prefix="unet"),
    secondary_model=dict(ckpt_path='https://download.openmmlab.com/mmediting/synthesizers/disco/secondary_model_imagenet_2.pth', prefix='')
)
