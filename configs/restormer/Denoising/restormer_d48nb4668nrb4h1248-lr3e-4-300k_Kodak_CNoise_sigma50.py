...
experiment_name = 'restormer_d48nb4668nrb4h1248-lr3e-4-300k\
    _Kodak_GNoise_sigma50'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/home/ywp/zwb/data/Test/Denoising/test_gussian',
        data_prefix=dict(img='input', gt='target'),
        ann_file='meta_info_cbsd68_test.txt',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/home/ywp/zwb/data/Test/Denoising/test_gussian',
        ann_file='meta_info_Kodak_test.txt',
        data_prefix=dict(img='Kodak', gt='Kodak'),
...
val_evaluator = [
    dict(type='MAE'),
    dict(type='PSNR', convert_to=None),
    dict(type='SSIM'),
]
