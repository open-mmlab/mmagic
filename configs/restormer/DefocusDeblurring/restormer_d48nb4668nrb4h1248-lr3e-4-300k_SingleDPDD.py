...
experiment_name = 'restormer_d48nb4668nrb4h1248-lr3e-4-300k_DPDD'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        metainfo=dict(dataset_type='dpdd', task_name='defocus_deblur'),
        data_root='/home/ywp/zwb/data/Defocus_Deblur_Test',
        data_prefix=dict(img='source', gt='target'),
        ann_file='meta_info_dpdd_test.txt',
