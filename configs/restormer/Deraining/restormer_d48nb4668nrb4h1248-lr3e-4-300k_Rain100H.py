...
experiment_name = 'restormer_d48nb4668nrb4h1248-lr3e-4-300k_Rain100H'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/home/ywp/zwb/data/Test/Deraining/Rain100H',
        data_prefix=dict(img='input', gt='target'),
        ann_file='meta_info_rain100h_test.txt',
