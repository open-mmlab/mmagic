...
experiment_name = 'restormer_d48nb4668nrb4h1248-lr3e-4-300k_RealBlurR'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        metainfo=dict(dataset_type='RealBlur_R', task_name='deblur'),
        data_root='/home/ywp/zwb/data/Test/Deblurring/RealBlur_R',
        data_prefix=dict(img='input', gt='target'),
        ann_file='meta_info_realblurr_test.txt',
