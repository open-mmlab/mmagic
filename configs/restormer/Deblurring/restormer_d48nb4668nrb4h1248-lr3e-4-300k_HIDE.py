...
experiment_name = 'restormer_d48nb4668nrb4h1248-lr3e-4-300k_HIDE'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        metainfo=dict(dataset_type='hide', task_name='deblur'),
        data_root='/home/ywp/zwb/data/Test/Deblurring/HIDE',
        data_prefix=dict(img='input', gt='target'),
        ann_file='meta_info_HIDE_test.txt',
