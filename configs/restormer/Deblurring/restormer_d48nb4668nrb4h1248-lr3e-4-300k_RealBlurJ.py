...
experiment_name = 'restormer_d48nb4668nrb4h1248-lr3e-4-300k_RealBlurJ'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        metainfo=dict(dataset_type='RealBlur_J', task_name='deblur'),
        data_root='/home/ywp/zwb/data/Test/Deblurring/RealBlur_J',
        data_prefix=dict(img='input', gt='target'),
        ann_file='meta_info_realblurj_test.txt',
