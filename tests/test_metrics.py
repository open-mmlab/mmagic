...
def test_calculate_niqe():
    ...
    np.testing.assert_almost_equal(result, 6.1590275)

    result = niqe(img, crop_border=0, input_order='HWC', convert_to='y')
    np.testing.assert_almost_equal(result, 5.8518299)
    result = niqe(img, crop_border=0, input_order='HWC', convert_to='gray')
    np.testing.assert_almost_equal(result, 5.8976678)
    ...
    np.testing.assert_almost_equal(result, 6.1443493)
