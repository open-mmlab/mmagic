...
class SRCustomMultipleGTDataset(BaseSRDataset):
    ...
    Args:
        ...
        num_input_frames (None | int): The number of frames per iteration.
            ...
            a positive integer, a sequence of 'num_input_frames' frames
            are extracted from the clip. Note that non-positive integers are
            not accepted. Default: None.
    ...
    def load_annotations(self):
        ...
        for sequence in sequences:
            ...
            if self.num_input_frames is None:
                num_input_frames = int(sequence_length)
            else:
