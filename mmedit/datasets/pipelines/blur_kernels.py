...
def sigma_matrix2(sig_x, sig_y, theta):
    ...
    return np.dot(rot, np.dot(diag, rot.T))
...
def calculate_gaussian_pdf(sigma_matrix, grid):
    ...
    Args:
        ...
        grid (ndarray): Coordinates generated by :func:`mesh_grid`,
...
def bivariate_gaussian(kernel_size,
    ...
    Args:
        ...
        sig_y (float): Standard deviation along the vertical direction.
        theta (float): Rotation in radian.
        grid (ndarray, optional): Coordinates generated by :func:`mesh_grid`,
...
def random_circular_lowpass(omega_range, kernel_size, pad_to=0):
...
def random_mixed_kernels(kernel_list,
    ...
    if kernel_type == 'iso':
        ...
        kernel = random_circular_lowpass(omega_range, kernel_size)
