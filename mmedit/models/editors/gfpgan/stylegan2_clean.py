...
from ..stylegan1 import (ConstantInput, EqualLinearActModule, get_mean_latent,
                         style_mixing)
from .stylegan2_clean_modules import ModulatedStyleConv, ModulatedToRGB


@MODULES.register_module('StyleGANV2GeneratorClean')
...
class StyleGAN2GeneratorClean(nn.Module):
    ...
    def train(self, mode=True):
        ...
        return super(StyleGAN2GeneratorClean, self).train(mode)
