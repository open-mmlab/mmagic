...
class CLIPLossModel(torch.nn.Module):
    ...
    def __init__(self,
                 in_size: Optional[int] = 1024,
                 scale_factor: Optional[int] = 7,
                 pool_size: Optional[int] = 224,
                 clip_type: Optional[str] = 'ViT-B/32') -> None:
...
class CLIPLoss(nn.Module):
    ...
    def __init__(self,
                 ...
                 clip_model: Optional[dict] = dict(),
                 loss_name: Optional[str] = 'loss_clip') -> None:
