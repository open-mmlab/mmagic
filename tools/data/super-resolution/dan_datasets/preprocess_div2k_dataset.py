...
def main_extract_subimages(args):
    ...
    # HR images
    opt['input_folder'] = osp.join(args.data_root, 'DF2K_train_HR')
    opt['save_folder'] = osp.join(args.data_root, 'DF2K_train_HR_sub')
...
def parse_args():
    ...
    parser.add_argument(
        '--step', nargs='?', default=128, help='step size for HR images')
    parser.add_argument(
        '--thresh-size',
        nargs='?',
        default=0,
